...
// ── the temporary install/download box was retired once the engines were in (B-0914-88) ──
ok(html.indexOf('trk-install') === -1 && html.indexOf('trk-download') === -1, 'track install/download workaround removed');
ok(/eng-import-input"/.test(html) && /importEnginePackage/.test(html), 'the general Import package flow stays (engine-builder skill depends on it)');
